 ...
 * @author Niels
 */
public class CustomMediaHelper {
    /**
     ...
     */
    public static boolean waitFor(Loadable m, int maxSeconds) throws InterruptedException {
     ...
     */
    public static boolean waitFor(Collection<? extends Loadable> _ms, int maxSeconds) throws InterruptedException {
